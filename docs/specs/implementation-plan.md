...
| Decide the **tutorial** and **reference-image** field lists | decision | Specific-field rendering is the one thing blocked on schema (§A01.2) | The generic editor does *not* need this; only the rich per-type view does. Decide enough to start, refine later |
