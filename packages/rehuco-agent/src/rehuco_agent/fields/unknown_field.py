...
(:data:`PROVENANCE_PLUGIN_ABSENT`, #84); refining *this* field-level flag by source stays deferred -- there is no
core-version model here yet to tell a newer common key from a newer plugin-block key."""
